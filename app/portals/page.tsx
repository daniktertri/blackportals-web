                ...
                <div className="phone-frame">
                  <div className="phone-screen">
                    {/* To add your screenshot, replace the placeholder div below with:
                        <img src="/path/to/your/screenshot1.jpg" alt="App Screenshot" className="phone-screenshot" />
                        Or use Next.js Image:
                        <Image src="/path/to/your/screenshot1.jpg" alt="App Screenshot" fill className="phone-screenshot" />
                    */}
